 ...
 * ----------------------------------------------------------------------------
 * Neuro-Fit owns this outright — the only landmark vocabulary the squat and
 * push-up coaches need. MediaPipe's NormalizedLandmark is structurally assignable to `Landmark`,
